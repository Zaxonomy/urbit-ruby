...
describe Urbit::Channel do
  ...
  it "is initialized with a name" do
    ...
    # This is channel 1, not 0, because initializing the ship opens a channel for the Groups
  ...
  it "can be represented as a string" do
    expect(channel.to_s).to eq("a Channel (Open) on ~zod(name: 'Channel-1', key: '#{channel.key}')")
  end
